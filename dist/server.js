...
server.listen(environment_1.environment.port).then(function (_a) {
    var url = _a.url;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4, axios.get("https://api.chucknorris.io/jokes/random?category=" + args.category)];
                        case 1:
                            response = _a.sent();
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => "1ffb5418880c8e2443b8"
/******/ 	})();
/******/ 	
